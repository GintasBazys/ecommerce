...
<template>
    <main class="min-h-screen bg-[linear-gradient(180deg,#f8fafc_0%,#eef2ff_38%,#fff7ed_100%)] text-slate-900">
        <section class="mx-auto w-full max-w-6xl px-4 pb-14 pt-8 sm:px-6 lg:px-8 lg:pt-12">
            <div class="grid items-start gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-8">
                <div class="space-y-6">
                    ...
                    <h1 class="max-w-[12ch] text-4xl font-semibold leading-[0.95] tracking-[-0.03em] text-slate-950 sm:text-6xl">
                    ...
                    <div class="rounded-3xl border border-slate-200 bg-white/85 p-4 sm:p-5">
                        <p class="text-xs font-medium uppercase tracking-[0.1em] text-slate-500">Next step</p>
