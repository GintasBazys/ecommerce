...
<template>
    ...
    >
        <div class="px-0 pb-4 pt-[3.75rem] sm:pt-[4.5rem] md:pt-[4.5rem] xl:pt-[5.75rem]">
            <div class="mx-auto w-full max-w-7xl px-4 sm:px-6">
                <div class="max-w-[42rem]">
                    ...
                    <h1
                        class="mt-4 text-[2rem] font-bold leading-[1] tracking-[-0.06rem] text-slate-950 sm:text-[2.75rem] sm:leading-[0.98] xl:text-[4.25rem] xl:leading-[0.96]"
                    >
