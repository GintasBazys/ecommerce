...
<template>
    <div class="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm sm:rounded-4xl sm:p-7 xl:p-8">
        <div v-if="variants.length" class="grid gap-4">
            ...
            <div class="flex flex-col gap-2.5 sm:flex-row sm:flex-wrap">
                <button
                    ...
                    :key="variant.id"
                    type="button"
                    class="inline-flex min-h-11 items-center justify-center rounded-full border px-4 text-sm font-semibold transition focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-amber-200 motion-reduce:transition-none sm:w-auto"
                    :class="
        ...
        <div class="mt-5 grid gap-3 border-t border-slate-200 pt-5 sm:grid-cols-3">
            <div class="flex items-center gap-3 rounded-[1.1rem] border border-slate-200 bg-slate-50 p-4 text-sm font-medium text-slate-700">
