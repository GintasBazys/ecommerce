...
<template>
    <select
        v-model="model"
        class="focus:border-brand-500 focus:ring-brand-100 shadow-card h-11 w-full appearance-none rounded-2xl border border-slate-300 bg-gradient-to-b from-white to-slate-50 px-4 pr-10 text-sm font-medium text-slate-900 outline-hidden transition focus:ring-2 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:opacity-70"
